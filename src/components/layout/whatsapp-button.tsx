...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed right-5 bottom-5 z-50 flex items-center gap-2 rounded-full bg-[#25D366] py-3 pr-3 pl-3 text-white shadow-lg shadow-black/20 transition-all duration-300 hover:pr-5 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366] sm:bottom-6"
    >
